        ...
        <section className="section" style={{ background: "var(--bg-section-alt)" }}>
          <div className="container contact-grid" style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 28, alignItems: "start", maxWidth: 1140 }}>
            ...
            <div data-animate="right" style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              <InfoCard ic="ti-phone" bg="var(--brand-green-pale)" color="var(--brand-green-dark)" title="Call Us" main="+91 70530 99911" sub="Mon–Sat, 9am–7pm IST" />
              <InfoCard ic="ti-mail" bg="rgba(6,182,212,0.12)" color="var(--accent-cyan)" title="Mail Us" main="support@gatimaan.in" sub="Reply within 24 hours" />
              <InfoCard ic="ti-map-pin" bg="rgba(27,43,107,0.1)" color="var(--brand-navy)" title="Visit Us" main="Gatimaan Payments Pvt. Ltd." sub="Address line, City, State — PIN" />
            </div>
          </div>
